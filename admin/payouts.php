    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-center"><!--- d-flex justify-content-center Starts --->
        ...
        <?php
          ...
          echo "<li class='page-item'><a href='index?payouts=1&status=$payoutStatus' class='page-link'> <i class='fa fa-angle-double-left' aria-hidden='true'></i> </a></li>";
          ...
          echo "<li class='page-item'><a href='index?payouts=$total_pages&status=$payoutStatus' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
        ?>
        </ul><!--- pagination Ends --->
