...
<div class="card-body"><!--- card-body Starts --->
    ...
    <div class="d-flex justify-content-center"><!--- d-flex justify-content-center Starts --->
        ...
        <ul class="pagination"><!--- pagination Starts --->
            ...
            echo "<li class='page-item'><a href='index?view_sellers=1&search=$search' class='page-link'> <i class='fa fa-angle-double-left' aria-hidden='true'></i> </a></li>";
            ...
            echo "<li class='page-item'><a href='index?view_sellers=$total_pages&search=$search' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
