...
<div class="container">
                 ...
                 <div class="col-lg-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered links-table">
                    ...
                    echo "<li class='page-item'><a href='index?inbox_conversations=1' class='page-link'><i class='fa fa-angle-double-left' aria-hidden='true'></i></a></li>";
                    ...
                    echo "<li class='page-item'><a href='index?inbox_conversations=$total_pages' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
