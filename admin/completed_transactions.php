...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body"><!--- card-body Starts --->
      ...
      echo "
      <li class='page-item'>
      <a href='index?completed_transactions=1' class='page-link'> <i class='fa fa-angle-double-left' aria-hidden='true'></i> </a>
      </li>
      ";
      ...
      echo "
      <li class='page-item'>
      <a href='index?completed_transactions=$total_pages' class='page-link'> <i class='fa fa-angle-double-right' aria-hidden='true'></i> </a>
      </li>
      ";
      ?>
      </ul><!--- pagination Ends --->
