...
<div class="card-body">
    ...
    <div class="d-flex justify-content-center">
        ...
        echo "<li class='page-item'><a href='index?view_seller_reviews=1' class='page-link'><i class='fa fa-angle-double-left' aria-hidden='true'></i></a></li>";
        ...
        echo "<li class='page-item'><a href='index?view_seller_reviews=$total_pages' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
