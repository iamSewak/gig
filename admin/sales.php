...
<div class="card-body"><!--- card-body Starts --->
  ...
  <table class="table table-bordered"><!--- table table-bordered table-hover Starts --->
    ...
    <div class="dropdown d-none"><!--- dropdown Starts --->
      ...
      echo "<li class='page-item'><a href='index?sales=1$filterUrl' class='page-link'><i class='fa fa-angle-double-left' aria-hidden='true'></i></a></li>";
      ...
      echo "<li class='page-item'><a href='index?sales=$total_pages$filterUrl' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
      ?>
    </ul>
  	</div>
  	</td>
