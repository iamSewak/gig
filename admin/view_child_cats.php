    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-center">
            ...
            <ul class="pagination">
                ...
                echo "<li class='page-item'><a href='index?view_child_cats=1' class='page-link'><i class='fa fa-angle-double-left' aria-hidden='true'></i></a></li>";
                ...
                echo "<li class='page-item'><a href='index?view_child_cats=$total_pages' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
