  ...
  // Here uploadPlugin Code
    ...
    if(!in_array($file_extension,$allowed) & !empty($zip_file)){
      ...
      if(move_uploaded_file($zip_file_tmp,"files/$zip_file")){
        ...
        $c_version = getStringBetween($readme,"Compatible miver Version: ","\n");
          ...
          if(!is_dir("../plugins/$folderName")){
            ...
            if($c_version <= $current_version){
              ...
              if($run->execute()){
                ...
                echo "<script>alert_success('This Plugin Will Only Work On miver $c_version And Above $c_version','index?plugins');</script>"; 
            }
