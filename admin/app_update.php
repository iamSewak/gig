    ...
    <div class="card mb-5"><!--- card mb-5 Starts --->
      ...
      <div class="card-body p-0"><!--- card-body Starts --->
        <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
          ...
          <small>Click here to get <a class="text-success" href="https://www.codester.com/items/7515/miver-freelance-service-marketplace">updated files</a></small>
          </div>
          </div><!--- form-group row Ends --->
          <hr class="mt-0 mb-3">
      ...
      if(!file_exists("updator/readme.txt") or !file_exists("updator/update.sql") or !file_exists("updator/files.zip")){
        ...
        if($current_version < $version){
          if($c_version == $current_version){
            ...
            swal({
            type: 'warning',
            text: 'This Update File Will Only Work On miver $c_version.',
            timer: 3000,
            onOpen: function(){
            swal.showLoading()
            }
