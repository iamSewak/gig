...
<?php
	...
	echo "<li class='page-item'><a href='index?admin_logs=1&date=$date&admin_id=$admin_id' class='page-link'> <i class='fa fa-angle-double-left' aria-hidden='true'></i> </a></li>";
    ...
    echo "<li class='page-item'><a href='index?admin_logs=$total_pages&date=$date&admin_id=$admin_id' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
