                  ...
                  <div class="d-flex justify-content-center"><!--- d-flex justify-content-center Starts --->
                      ...
                      <ul class="pagination"><!--- pagination Starts --->
                        ...
                        <?php
                         ...
                         echo "<li class='page-item'><a href='index?buyer_requests=1&status=$status' class='page-link'> <i class='fa fa-angle-double-left' aria-hidden='true'></i> </a></li>";
                         ...
                         echo "<li class='page-item'><a href='index?buyer_requests=$total_pages&status=$status' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
