...
<div class="row"><!--- 3 row Starts --->
    ...
    <div class="col-lg-12"><!--- col-lg-12 Starts --->
        ...
        echo "
        <li class='page-item'>
            <a href='index?view_order_files=1' class='page-link'> <i class='fa fa-angle-double-left' aria-hidden='true'></i> </a>
        </li>";
        ...
        echo "
        <li class='page-item'>
            <a href='index?view_order_files=$total_pages' class='page-link'> <i class='fa fa-angle-double-right' aria-hidden='true'></i> </a>
        </li>";
