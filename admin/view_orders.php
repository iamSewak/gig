    ...
    <div class="d-flex justify-content-center">
      ...
      <ul class="pagination">
        ...
        <?php
          ...
          echo "<li class='page-item'><a href='index?view_orders=1' class='page-link'> <i class='fa fa-angle-double-left' aria-hidden='true'></i> </a></li>";
          ...
          echo "<li class='page-item'><a href='index?view_orders=$total_pages' class='page-link'><i class='fa fa-angle-double-right' aria-hidden='true'></i> </a></li>";
