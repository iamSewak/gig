...
if($recordingPlugin == 1){
  $recorder_max_minutes = $row_general_settings->recorder_max_minutes;
}
...
<span class="text-danger font-weight-bold">NB:</span>
  Enter the complete url. Ex: https://www.miver.com
</small>
</div>
</div><!--- form-group row Ends --->
...
<small><a target="_blank" href=https://help.miverscript.com/knowledge/details/12/Steps%20on%20Getting%20Google%20reCaptcha%20key%20%20secret.html" class="text-success">How To?</a></small>    
</label>
<div class="col-md-6">
<div class="input-group">
...
<?php if($recordingPlugin == 1){ ?>

<div class="form-group row"><!--- form-group row Starts --->
  <label class="col-md-3 control-label"> Recorder Max Minutes : </label>
  <div class="col-md-6">
    <div class="input-group"><!--- input-group Starts --->
    <input type="number" name="recorder_max_minutes" class="form-control" min="1" value="<?= $recorder_max_minutes; ?>">
    <span class="input-group-addon"><b>minutes</b></span>
    </div><!--- input-group Ends --->
...
<small><a target="_blank" href="http://help.miverscript.com/knowledge/details/6/.html" class="text-success">How To?</a></small>
</label>
<div class="col-md-6">
<div class="input-group">
<span class="input-group-addon">
...
<small><a target="_blank" href="http://help.miverscript.com/knowledge/details/7/.html" class="text-success">How To?</a></small>
</label>
<div class="col-md-6">
<div class="input-group">
<span class="input-group-addon">
...
if(isset($_POST['general_settings_update'])){
  ...
  if($recordingPlugin == 1){
    $recorder_max_minutes = $input->post('recorder_max_minutes');
  }
  ...
  if(!in_array($favicon_extension,$allowed) & !empty($site_favicon) or !in_array($logo_extension,$allowed) & !empty($site_logo) or !in_array($logo_image_extension,$allowed) & !empty($site_logo_image)){
    ...
    if($recordingPlugin == 1){
      $update_data['recorder_max_minutes'] = $recorder_max_minutes;
    }

    $update_general_settings = $db->update("general_settings",$update_data);
