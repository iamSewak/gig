...
<head>
    ...
    <meta name="description" content="With the miverScript admin panel, controlling your website has never been eassier.">
    <meta name="author" content="miverScript">
...
if ($count_proposals == 0) {
  echo "<tr><td colspan='9'><h5 class='text-center'><i class='fa fa-meh-o'></i> We haven't found any proposals matching that search </h5></td></tr>";
}
