...
if($recordingPlugin == 1){
  $recording = $row_order_conversations->recording;
}else{
  $recording = 0;
}
...
if(!empty($file)){
  ...
  if($recording == 1){
    ...
    echo "
      <a href='#' class='play-recording d-block mt-2 ml-1' data-id='$c_id' data-type='order'>
        <i class='fa fa-play-circle'></i> $file_name
      </a>
    ";
...
<h5 class="text-danger">Cancellation Request Declined By <?= $receiver_name; ?></h5>
...
<div class="card mt-4">
  ...
  <div class="card-body">
    ...
    <h5 class="text-center">
      <img src="images/svg/cancellation.svg" class="order-icon"/> Cancellation Request By <?= $seller_user_name; ?>
    </h5>
