...
<div class="insert-message-box">
  ...
  <form id="insert-message-form" class="clearfix">
    ...
    <div class="float-left b-2">
      <p id="spamWords" class="mt-1 text-danger d-none">
        <i class="fa fa-warning"></i> You seem to have typed word(s) that are in violation of our policy. No direct payments or emails allowed.
      </p>
    </div>
    ...
    <?php if($recordingPlugin == 1){ ?>
      ...
      <button type="button" class="btn btn-info create-record float-left" data-toggle="modal" data-target="#recording-modal">
        <i class="fa fa-video-camera"></i> Create a new recording
      </button>
    ...
    <div class="form-row align-items-center message-attacment"><!-- form-row align-items-center message-attachment Starts -->
      <label class="h6 ml-2 mt-1"> Attach File (optional) </label>
      <input type="file" name="file" class="form-control-file p-1 mb-2 mb-sm-0">
    </div><!-- form-row align-items-center message-attachment Ends -->
