...
?>
<!DOCTYPE html>
<html lang="en" dir="<?=($lang_dir == "right" ? 'rtl':'ltr')?>" class="<?=($lang_dir == "right" ? 'rtl':'ltr')?> ui-toolkit">
<head>
...
<body class="is-responsive">
 ...
 <section id="how_to" class="blog-details freelanceheader bg-gradient related-links related-links-bg bb-xs-1">
  <div class="freelancersbg container">
    <h2 class="pb-2 text-white"><?= $page_title; ?></h2>
    <p>
      <a class="text-white" href="<?= $site_url; ?>">Home</a>  / 
