  ...
  <div class="row">
    ...
    <div class="col-md-9 <?=($lang_dir == "right" ? 'order-1 order-sm-2':'')?>">
      ...
      <div class="row mt-4 mb-3">
        <div class="col-md-12">
          <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?>"><?= $lang['user_home']['featured_proposals']; ?></h3>
      ...
      <div class="row">
        <?php
          ...
          ?>
        <div class="cardstyle col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 pr-lg-1">
      ...
      <div class="row mb-3">
        <div class="col-md-12">
          <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?>"><?= $lang['user_home']['top_proposals']; ?></h3>
      ...
      <div class="row mb-3">
        <div class="col-md-12">
          <h3 class="pl-0 pr-0 ml-0 mr-0 <?=($lang_dir == "right" ? 'float-right':'float-left')?>"><?= $lang['user_home']['random_proposals']; ?></h3>
      ...
      <div class="row mt-2 mb-3">
        <div class="col-md-12">
          <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?>"><?= $lang['user_home']['recent_requests']; ?></h3>
