   ...
   <div class="row justify-content-center p-4 mb-5">
      <div class="row" id="favorites">
         <div class="col-lg-8 col-md-12 mb-3">
            ...
            <p class="favorite-description text-white"><?= $lang["titles"]["favorites"]["desc"]; ?></p>
            <p>
         ...
         <div class="col-lg-4 col-md-12">
            ...
            <div class="favorite-owner">
              ...
              <p><?= $lang['favorites']['collected_by']; ?> : <?= $login_seller_user_name; ?></p>
...
<div class="container cardstyle cardstyle-big pt-1">
  <div class="row mb-4">
    <?php
      $get_favorites = $db->select("favorites",array("seller_id" => $login_seller_id));
      while($row_favorites = $get_favorites->fetch()){
  ...
  <?php 
    if($count_favorites == 0){
      ...
      <h5 class='pt-5 pb-5'><i class='fa fa-meh-o'></i> {$lang['favorites']['no_favorites']}</h5>
      </span>";
