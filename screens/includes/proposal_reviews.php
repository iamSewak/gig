...
<li>
	<div class="d-flex">
		<div class="left">
			<span style="<?=($lang_dir == "right" ? 'left:auto;margin-left:6px;':'')?>">
				<?php if(!empty($buyer_image)){ ?>
				<img src="<?= $buyer_image; ?>" class="profile-pict-img img-fluid">
				<?php }else{ ?>
				<img src="../../user_images/empty-image.png" class="profile-pict-img img-fluid">
				<?php } ?>
			</span>
		</div>
		<div class="right">
			<h4><!-- h4 Starts -->
				...
				<?php
					...
					echo "  <span class='gig-rating text-body-2'><img class='rating' src='../../images/user_rate_full.png'></span> ";
					}
					for($buyer_i=$buyer_rating; $buyer_i<5; $buyer_i++){
					echo "  <span class='gig-rating text-body-2'><img class='rating' src='../../images/user_rate_blank.png'></span>";
					}
				?>
			</h4>
				...
				<div class="left">
					<span>
						<?php if(!empty($proposal_seller_image)){ ?>
							<img src="<?= getImageUrl2("sellers","seller_image",$proposal_seller_image); ?>" class="profile-pict-img img-fluid">
						<?php }else{ ?>
							<img src="../../user_images/empty-image.png" class="profile-pict-img img-fluid">
						<?php } ?>
					</span>
