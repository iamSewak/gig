...
<div class="card rounded-0 mb-3 welcome-box"><!-- card rounded-0 mb-3 welcome-box Starts -->
	<div class="card-body pb-2"><!-- card-body Starts -->
		...
		<h5 style="text-align: center;"><?= $lang['welcome']; ?>, <span class="text-success"><?= ucfirst(strtolower($login_user_name)); ?></span> </h5>
		<hr>
...
<div class="row m-0"><!--- row Starts --->
			<div class="col-lg-12 m-0 p-0  pb-lg-0  pb-md-2 "><!--- col-md-6 Starts --->
				<h5>
					<i class="fa fa-tachometer" aria-hidden="true"></i> 
					<a href="<?= $site_url; ?>/dashboard"><?= $lang['menu']['dashboard']; ?></a>
				</h5>
				<h5><i class="fa fa-plus-square-o" aria-hidden="true"></i><a href="<?= $site_url; ?>/proposals/create_proposal"><?= $lang['user_home']['add_proposal']; ?></a></h5>
				<h5><i class="fa fa-plus-square-o" aria-hidden="true"></i><a href="<?= $site_url; ?>/requests/post_request"><?= $lang['menu']['post_request']; ?></a></h5>
			<!--- col-md-6 Starts --->
				<?php if(isset($count_active_proposals) AND @$count_active_proposals  > 0){ ?>
				<h5><i class="fa fa-line-chart" aria-hidden="true"></i> <a href="<?= $site_url; ?>/selling_orders"><?= $lang['user_home']['view_sales']; ?></a></h5>
				<?php }else{ ?>
				<h5><a href="<?= $site_url; ?>/buying_orders"><?= $lang['user_home']['view_purchases']; ?></a></h5>
				<?php } ?>
				<h5><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <a href="<?= $site_url; ?>/settings?profile_settings"><?= $lang['user_home']['edit_profile']; ?></a></h5>
				<h5 class="mb-0"><i class="fa fa-cog" aria-hidden="true"></i><a href="<?= $site_url; ?>/settings"><?= $lang['menu']['settings']; ?></a></h5>
			</div><!--- col-md-6 Ends --->
</div>
...
<div class="rounded-0 carosel_sec">
	...
	?>
  <div id="demo" class="cardstyle carousel slide" data-ride="carousel"><!-- The slideshow -->
...
<h3 class="buy_head <?=($lang_dir == "right" ? 'text-right':'')?>"><?= $lang['sidebar']['recently_viewed']; ?></h3>
  ...
  ?>
  <div id="demo2" class="cardstyle carousel slide" data-ride="carousel"><!-- The slideshow -->
  <div class="carousel-inner " role="listbox">
	<?php
	$i = 0;
      ...
      <div class="inner-wrapper">
         <div class="d-flex align-items-center">
            <span class="seller-image">
            	<img class="img-fluid" src="<?= $seller_image; ?>" alt="">
            </span>
