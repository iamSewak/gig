<li class="logged-in-link d-none d-sm-block d-md-block d-lg-block">
  <a class="menuItem" href="<?= $site_url; ?>/blog/" title="<?= $lang["blog"]['title']; ?>">
    <span class="miver-icon nav-icon miver-icon-relative">
...
<li class="logged-in-link">
  ...
  <span class="miver-icon nav-icon miver-icon-relative"><?php include("{$dir}images/svg/notification.svg"); ?></span>
...
<li class="logged-in-link">
  ...
  <span class="miver-icon nav-icon miver-icon-relative"><?php include("{$dir}images/svg/email.svg"); ?></span>
...
<li class="logged-in-link">
  ...
  <span class="miver-icon nav-icon miver-icon-relative"><?php include("{$dir}images/svg/heart.svg"); ?> </span>
  <span>
...
<li class="logged-in-link">
  ...
  <span class="miver-icon nav-icon miver-icon-relative"><?php include("{$dir}images/svg/basket.svg"); ?></span>
  <?php if($count_cart > 0){ ?>
