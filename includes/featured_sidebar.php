...
<div id="accordion">
   ...
   <div class="filters-card border-bottom p-4">
      <div class="filters-card-header" id="headingOne">
         <h6 class="mb-0">
            <a href="#" class="<?=($lang_dir == "right" ? 'float-right-':'float-left-')?> btn-link" data-toggle="collapse" data-target="#collapse_Categories" aria-expanded="false" aria-controls="collapse_Categories">
      ...
      <div id="collapse_Categories" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
   ...
   <div class="filters-card border-bottom p-4">
      <div class="filters-card-header" id="headingOne">
         <h6 class="mb-0">
            <a href="#" class="<?=($lang_dir == "right" ? 'float-right-':'float-left-')?> btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
   ...
   <div class="filters-card border-bottom p-4">
      <div class="filters-card-header" id="headingOne">
         <h6 class="mb-0">
            <a href="#" class="<?=($lang_dir == "right" ? 'float-right-':'float-left-')?> btn-link" data-toggle="collapse" data-target="#collapse_lang" aria-expanded="false" aria-controls="collapse_lang">
      ...
      <div id="collapse_lang" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
         <div class="filters-card-body card-shop-filters">
            <ul class="nav flex-column">
               <?php
