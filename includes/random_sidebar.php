    ...
    <i class="fa fa-times-circle"></i> Clear Filter
      ...
      <div id="collapse_city" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
         <div class="filters-card-body card-shop-filters">
              <ul class="nav flex-column">
      <?php
        $get_proposals = $db->query("select DISTINCT proposal_cat_id from proposals where proposal_status='active' order by 1 asc");
        while($row_proposals = $get_proposals->fetch()){
    ...
    <i class="fa fa-times-circle"></i> Clear Filter
      ...
      <div id="collapse_delivery" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
         <div class="filters-card-body card-shop-filters">
              <ul class="nav flex-column">
      <?php
        $get_proposals = $db->query("select DISTINCT delivery_id from proposals where proposal_status='active'");
        while($row_proposals = $get_proposals->fetch()){
    ...
    <i class="fa fa-times-circle"></i> Clear Filter
      ...
      <div id="collapse_level" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
         <div class="filters-card-body card-shop-filters">
              <ul class="nav flex-column">
      <?php
        $get_proposals = $db->query("select DISTINCT level_id from proposals where proposal_status='active'");
        while($row_proposals = $get_proposals->fetch()){
