...
<div class="container mt-5">
	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-4 mx-auto bg-white mb-5">
                  <div class="osahan-login py-4">
                    

                     <div class="text-center mb-4">
                        <a href="#"><i class="fa fa-unlock-alt" style="
    font-size: 22px;
"></i></a>
                        <h5 class="font-weight-bold mt-3">Welcome Back</h5>
                        <p class="text-muted"><?= str_replace('{site_name}',$site_name,$lang['login']['title']); ?></p>
                     </div>
					...
					<?php } ?>
                     ...
                     <form action="" method="post">
                        ...
                        <input type="submit" name="access" class="btn btn-success text-uppercase btn-block" value="<?= $lang['button']['login']; ?>" required>
