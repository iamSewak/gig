...
<div class="wide-header">
  ...
  <div class="row mt-3 bg-whaite">
    <div class="col-md-12">
      <center>
        <h1><?= $lang['search']['title']; ?></h1>
        <p class="lead"> "<?= @$_SESSION["search_query"]; ?>" </p>
      </center>
      <hr>
    </div>
  </div>
...
<div class="container mt-3"> <!-- Container start -->
  <div class="row mt-3">
      ...
      <div class="col-lg-9 col-md-8 col-sm-12 view_slider recommended<?=($lang_dir == "right" ? 'order-1 order-sm-2':'')?>">
