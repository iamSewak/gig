...
<head>
    ...
    <link href="../styles/css/style.css" rel="stylesheet"><!-- Custom css code from modified in admin panel --->
                   ...
                   <div class="table-responsive box-table mt-4">
                       ...
                       <?php
                            if($count_proposals == 0){
                                echo "<center><h5 class='pt-4 pb-4'><i class='fa fa-meh-o'></i> You currently have no proposals/services to sell.</h5></center>";
                            }
                       ?>
					</div>
				</div>
...
EOT;
                       ...
                       <?php
                            if($count_proposals == 0){
                                echo "<center><h5 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> You currently have no paused proposals/services.</h5></center>";
                            }
                       ?>
					</div>
				</div>
				<div id="pending-proposals" class="tab-pane fade show">
                   <div class="table-responsive box-table mt-4">
                        ...
                        <?php
                            if($count_proposals == 0){
                                echo "<center><h5 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> You currently have no proposals/services pending.</h5></center>";
                            }
                       ?>
					</div>
				</div>
         	<div id="modification-proposals" class="tab-pane fade show">
                   <div class="table-responsive box-table mt-4">
                       ...
                       <?php
                            if($count_proposals == 0){
                                echo "<center><h5 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> You currently have no modifications requested.</h5></center>";
                            }
                       ?>
					</div>
				</div>
				<div id="draft-proposals" class="tab-pane fade show">
                   <div class="table-responsive box-table mt-4">
                       ...
                       <?php
                        if($count_proposals == 0){
                          echo "<center><h5 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> You currently have no proposals/services in draft.</h5></center>";
                        }
                       ?>
					</div>
				</div>
				<div id="declined-proposals" class="tab-pane fade show">
                   <div class="table-responsive box-table mt-4">
                        ...
                        <?php
                            if($count_proposals == 0){
                                echo "<center><h5 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> You currently have no proposals/services declined.</h5></center>";
                            }
                       ?>
					</div>
				</div>
