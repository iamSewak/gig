...
<!-- Lightgallery -->
<link href="../../styles/lightgallery-master/dist/css/lightgallery.min.css" rel="stylesheet">
...
<div id="image-modal" class="modal fade"><!-- report-modal modal fade Starts -->
	<div class="modal-dialog" style="max-width:800px;"><!-- modal-dialog Starts -->
		<div class="modal-content"><!-- modal-content Starts -->
			<button class="close close-btn" data-dismiss="modal"><span>&times;</span></button>
