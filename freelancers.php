...
<?php require_once("includes/header.php"); ?>
  <section class="freelanceheader bg-gradient related-links related-links-bg bb-xs-1">
    <div class="freelancersbg container">
    <h2 class="pb-2"><?= $lang['freelancers']['title']; ?></h2>
    <h5>A single place, millions of creative talents <!--<?= $lang['freelancers']['desc']; ?> --></h5>
  </div>
  </section>
