      ...
      <div id="order-activity" class="tab-pane fade show active">
        <div class="row">
          ...
          <?php 
            ...
            require_once("orderIncludes/insertMessageBox.php");

            /// Recording Plugin Code Starts
            if($recordingPlugin == 1){
              require_once("plugins/recordingPlugin/recorder/index.php");
            }
            /// Recording Plugin Code Ends
...
<div class="view-recording"></div>

<script>
  var base_url = '<?= $site_url; ?>';
  var content_id = '<?= $order_id; ?>';
  var recording_type = 'order';
</script>

<!-- DetectRTC.js,RecordRTC.min.js,recording.js (for audio/video/screen recording) -->
<script src="plugins/recordingPlugin/js/DetectRTC.min.js"></script>
<script src="plugins/recordingPlugin/js/RecordRTC.min.js"></script>
<script src="plugins/recordingPlugin/js/recorder.js"></script>
<script src="plugins/recordingPlugin/js/site-recording.js"></script>
