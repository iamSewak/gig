...
function get_proposals($filter_type){
   ...
   if($count_proposals == 0){
      ...
      if($filter_type == "search"){
         ...
         echo"
         <div class='col-md-12'>
            <h2 class='mt-4'>{$lang['search']['no_results']}</h2>
         </div>";
         ...
         if(isset($_SESSION['cat_id'])){
            echo "
            <div class='col-md-12'>
            <h2 class='mt-4'>{$lang['category']['no_results']}</h2>
            </div>";
         }elseif(isset($_SESSION['cat_child_id'])){
            echo "
            <div class='col-md-12'>
            <h2 class='mt-4'>{$lang['sub_category']['no_results']}</h2>
            </div>";
         }
         ...
         echo "
         <div class='col-md-12'>
            <h2 class='mt-4'> {$lang['tag_proposals']['no_results']}  </h2>
         </div>";
         }
      }else{
         echo "
