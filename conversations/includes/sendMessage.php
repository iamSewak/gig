...
<div class="sendMessage pl-3 pr-3 pb-3">
  <p class="bg-danger p-2 text-white mv-0 d-none">
  ...
  <div class="alert alert-info mt-2">
    <div id="seller-vacation-div" class="mb-0">
      <p class="lead mb-0">
        <strong>Opps! </strong> This seller is on vacation and is not receiving messages at the moment. Please try again later.
      </p>
    </div>
  </div>
  <?php } ?>
  ...
  <?php if($recordingPlugin == 1){ ?>
    ...
    <button type="button" class="btn btn-outline-info float-left create-record float-left mr-2" data-toggle="modal" data-target="#recording-modal">
