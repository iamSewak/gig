<?php
	...
	if($recordingPlugin == 1){
	  $recording = $row_inbox_messages->recording;
	}else{
	  $recording = 0;
	}
    ...
    <div class="media-body">
      ...
      <?php } ?>
			...
			<!--- Recording Plugin Code Starts --->
      	<?php if($recording == 1){ ?>
				<a href="#" data-id="<?= $message_id; ?>" data-type="inbox" class="play-recording d-block mt-2 ml-1">
					<i class="fa fa-play-circle"></i> <?= $message_file; ?>
				</a>
      	<?php }else{ ?>
