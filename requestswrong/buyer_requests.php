        ...
        <div class="tab-content mt-4">
          <div id="active-requests" class="tab-pane fade show active">
            <div class="table-responsive box-table">
              ...
              <?php
                ...
                echo"<center><h5 class='pb-4 pt-4'><i class='fa fa-frown-o'></i> No requests that matches any of your proposals/services yet!</h5></center>";
                }
              ?>
            </div>
          </div>
          <div id="sent-offers" class="tab-pane fade">
            <div class="table-responsive box-table">
              ...
              <?php
                if($count_offers == 0){
                echo"<center><h5 class='pb-4 pt-4'><i class='fa fa-meh-o'></i> You've sent no offers yet!</h5></center>";
                }
                ?>
            </div>
          </div>
