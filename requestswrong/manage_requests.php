                     ...
                     <?php } ?>
                        ...
                        <?php
                          ...
                          if($count_requests == 0){
                              ...
                              echo "<center>
                              <h5 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> {$lang['manage_requests']['no_pause']} </h5>
                              </center>";
                          }
					...
					<div class="table-responsive box-table">
                        ...
                        <?php
                          ...
                          if($count_requests == 0){
                              ...
                              echo "<center><h5 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> {$lang['manage_requests']['no_pending']} </h5></center>";
                          }
					...
					<div class="table-responsive box-table">
                        ...
                        <?php
                          ...
                          if($count_requests == 0){
                              ...
                              echo "<center><h5 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> {$lang['manage_requests']['no_unapproved']} </h5></center>";
                          }
